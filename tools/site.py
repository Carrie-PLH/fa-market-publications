...
{md_to_html(body_md)}
  ...
  <div class="apparatus">
    <div>
      ...
      <p>Cite the edition and its version. If a later revision changes a figure, the revision is dated on this page and the original text stays visible. See <a href="/reuse/">Cite and reuse</a>.</p>
    </div>
    <div>
      <h2>Download</h2>
      <ul class="files">
...
<article class="article">
  ...
  <div class="prose">
    ...
    <h2>Reuse terms</h2>
    <p>Reuse terms for Field Assembly's own material are pending an owner decision and will be stated here when made. Until then: quote and cite freely under ordinary fair-use and fair-dealing practice, and write to hello@fieldassembly.net for anything beyond that. Downloading a table for your own analysis is what the tables are for.</p>
